...
def train_autoencoder(
    file_path="data/processed/ess_period_1.csv",
    latent_dim=10,
    batch_size=256,
    num_epochs=20,
    lr=1e-3
    ...
    print(f"🚀 Training Autoencoder: {X.shape[1]} → {latent_dim} latent units")
    ...
    with torch.no_grad():
        ...
        pd.DataFrame(latents.numpy()).to_csv("outputs/latents/ess_latents.csv", index=False)

    print("✅ Training complete. Latents saved to outputs/latents/ess_latents.csv")
